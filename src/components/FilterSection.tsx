...
function FilterSection({ onFilterChange }: { onFilterChange: (filters: any) => void }) {
    ...
    return (
        <div className="w-full lg:w-72 bg-white border border-gray-300 rounded-2xl p-5 shadow-md">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              {sizes.map((size) => (
                <button
                  key={size}
                  className={`text-sm font-medium rounded-3xl px-4 py-2 transition-all ${
          ...
          {/* <div className="mb-6">
            ...
            <div className="space-y-3">
              {dressStyles.map((style) => (
                <div key={style} className="flex items-center justify-between text-gray-700 hover:text-black">
                  <span>{style}</span>
          ...
          <button
            ...
            className="w-full bg-black text-white py-3 rounded-lg font-semibold text-sm hover:bg-gray-900 transition"
          >
            Apply Filter
          </button>
        </div>
