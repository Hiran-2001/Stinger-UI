    ...
    return (
      <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300">
        <Link to={`/shop/product/${product?.id}`}>
          <div className="bg-gray-100 rounded-lg p-2 flex items-center justify-center h-56 sm:h-64 md:h-72">
            <img
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center text-yellow-500 mt-1">
              ...
              <span className="text-gray-600 ml-2 text-xs sm:text-sm">{product.rating}/5</span>
            </div>
    
            <div className="flex items-center mt-2 space-x-2">
              <p className="text-sm sm:text-lg font-semibold text-black">₹ {product.price}</p>
              {product.originalPrice && (
                <>
                  <p className="text-gray-500 line-through text-xs sm:text-base">₹{product.originalPrice}</p>
